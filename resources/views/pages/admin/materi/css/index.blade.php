         ...
         <div class="card shadow mb-4">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              ...
              <img src="{{url('frontend/img/materi/CSS.png')}}"><br>
              <span>Selasa,18/01/2020  02:00:00 Wib</span>
              <h4>Belajar Dasar CSS dari 0</h4>
              <span class="bg-dark text-light px-2 py-1" style="font-size: 12px; border-radius: 5px">Casscading Style</span>
