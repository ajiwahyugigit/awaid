     ...
     <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
         ...
         <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <a href="{{route('phpcreate')}}" class="btn btn-primary mb-3">
              Post<i class="fa fa-plus-circle pl-2"></i>
            </a>
            
            <div class="table-responsive">

              <img src="{{url('frontend/img/materi/PHP.png')}}"><br>
              <span>Selasa,18/01/2020  02:00:00 Wib</span>
              <h4>Belajar Dasar PHP dari 0</h4>
              <span class="bg-dark text-light px-2 py-1" style="font-size: 12px; border-radius: 5px">PHP</span>
